...
function RejectedPage({open, setOpen}) { 
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="px-6 flex flex-col gap-1">
          <p className="text-[#364152] text-2xl font-medium tracking-tight">{t('Your offer has been rejected')}</p>
          <p className="text-[#666B6D] text-base font-normal">{t('Unfortunately, your offer was not selected this time.')}</p>
        </motion.div>
