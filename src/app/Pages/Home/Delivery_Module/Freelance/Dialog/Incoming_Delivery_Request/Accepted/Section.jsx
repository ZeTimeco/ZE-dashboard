...
function Section() {
  ...
  return (
    ...
    >
      <img
        src="/images/icons/checkmark-circle-true_green.svg"
        className="h-30 w-30"
      />
    </motion.p>
      <p className='text-[#364152] text-xl font-medium'>{t('Your offer has been accepted')}</p>  
      <p className='text-[#697586] text-lg font-normal text-center'>{t('You can now track the status of your current offer and monitor order updates step by step.')}</p>
    </div>
