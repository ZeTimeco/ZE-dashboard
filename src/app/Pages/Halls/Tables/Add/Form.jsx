          ...
          {getTage?.tags?.map((tag)=>{
            ...
            return (
              <button
                ...
                className={`
                  min-h-10 px-4 py-2 flex justify-center items-center gap-2 text-sm font-normal rounded-full border hover:scale-[1.02] active:scale-[0.98] transition-all duration-150
                  ${
                    isSelected
