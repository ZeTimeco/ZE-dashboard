  ...
  return (
    ...
    <div className='shadow-[0_0_4px_0_rgba(0,0,0,0.20)] p-4'>
      <div className='flex justify-between'>
        ...
        <p className='text-primary text-base font-bold'>  200 {t('pound')} </p>
      </div>
      <div className='flex justify-between mt-4'>
        <p className='text-[#697586] text-sm font-normal'>{t('payment method')}</p>
        <p className='text-[#161616] text-sm font-normal'>  نقدي عند التسليم  </p>
      </div>
    </div>
    ...
    <div className='shadow-[0_0_4px_0_rgba(0,0,0,0.20)] p-4 mt-4 flex justify-between'>
      <div className='flex flex-col gap-2'>
        ...
        <p className='text-[#3B3B3B] text-base font-medium'>أحمد محمد</p>
      </div>
      <p className='text-primary text-base font-bold  flex items-center'>  200 {t('pound')} </p>
    </div>
