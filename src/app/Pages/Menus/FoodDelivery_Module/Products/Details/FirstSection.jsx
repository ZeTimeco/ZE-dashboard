    ...
    <>
      ...
      <div className='flex justify-between items-center mt-6'>
        ...
        {getProductDetailsData?.is_visible ? (
          <p className='border border-[#067647] bg-[#DCFAE6] text-[#067647] rounded-full w-fit px-3 py-0.5 text-xs font-normal'>
      ...
      <div className='flex justify-between items-center mb-4'>
        ...
        <motion.button 
          ...
          className='border border-[var(--color-primary)] flex items-center gap-2 px-3 py-1 rounded-[3px] cursor-pointer hover:bg-[#FFFDF5] transition-colors duration-150'
        >
