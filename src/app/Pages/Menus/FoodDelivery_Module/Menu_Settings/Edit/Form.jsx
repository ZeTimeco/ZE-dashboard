...
function Form({formData, setFormData}) {
  ...
  return (
    <>
      <div className='shadow-[0_0_4px_0_rgba(0,0,0,0.20)] p-4 rounded-[3px] grid grid-cols-1 md:grid-cols-2 gap-4 bg-white'>
        {/* Product Name (arabic) */}
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 my-6'>
        {/* active */}
        <div className='shadow-[0_0_4px_0_rgba(0,0,0,0.20)] p-3 rounded-[3px] flex justify-between items-center bg-white hover:bg-gray-50/70 transition-colors duration-150'>
