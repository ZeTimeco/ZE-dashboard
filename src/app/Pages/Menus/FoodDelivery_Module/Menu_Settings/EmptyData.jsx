...
function EmptyData() {
  ...
  return (
    ...
    >
      ...
      <p className='text-[#697586] text-xl font-normal text-center'>{t('Add new categories now to allow your customers to customize their products.')}</p>
      <motion.button
        whileHover={{ scale: 1.02 }}
        whileTap={{ scale: 0.98 }}
        onClick={()=>router.push(`/Pages/Menus/FoodDelivery_Module/Menu_Settings/Add`)}
