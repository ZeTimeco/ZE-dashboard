        ...
        {menuItems.map((item) => {
          ...
          <div key={item.id} className="w-full">
            <motion.li
              ...
              className={`px-4 py-3 w-full text-base font-normal cursor-pointer flex items-center gap-3 rounded-[3px] transition-colors duration-200 ${
                isSelected 
                  ? 'bg-[var(--color-primary)] text-white' 
                  : 'text-[#364152] hover:bg-gray-100'
              }`}
