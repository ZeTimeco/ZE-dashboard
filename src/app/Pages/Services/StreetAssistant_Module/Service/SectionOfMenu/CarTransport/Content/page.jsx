...
function ContentPage() {
  ...
  useEffect(() => { dispatch(getStreetServiceByIdThunk()) }, [dispatch])
  ...
  const handleSave = () => {
    ...
    const data = { service_setting_id: batteryReviveService.settings.id, price: price, is_day_only: isDayOnly, additional_price: additional_price }
