...
function BookingStatus({formData , setFormData }) {
    ...
    <div className='shadow-[0_0_4px_0_rgba(0,0,0,0.20)] p-4'>
      ...
      <div className='grid grid-cols-1 lg1:grid-cols-3 gap-4 mt-4'>
        ...
        <div 
          ...
          className={`flex gap-4 border rounded-[3px] p-4 w-full cursor-pointer transition-all duration-200 ${getCardStyle('busy')}`}
        >
          <div className='flex items-center'>
            <input 
              type="radio" 
