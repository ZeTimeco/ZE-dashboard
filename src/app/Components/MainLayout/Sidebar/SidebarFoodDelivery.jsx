...
function SidebarFoodDelivery({ isSidebarOpen, setIsSidebarOpen }) {
  ...
  const mainNavItems = [
    {
      key: "Requests",
      path: "/Pages/requests/FoodDelivery_Module",
      icon: "/images/icons/Requests.svg",
    },
    {
      key: "menu",
      path: "/Pages/Menus/FoodDelivery_Module",
      icon: "/images/icons/dish-black.svg",
    },
    {
      key: "Delivery",
      path: "/Pages/Delivery/FoodDelivery_Module",
    ...
    {
      key: "Reports",
      path: "/Pages/Reports/FoodDelivery_Module",
      icon: "/images/icons/analytics-black.svg",
    },
    {
      key: "conversations",
